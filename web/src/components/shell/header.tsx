    ...
    <header className="sticky top-0 z-40 bg-surface border-b border-border shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          {/* Mobile: theme toggle + phone + hamburger */}
          <div className="flex items-center gap-1.5 lg:hidden">
            ...
            <Link
              ...
              aria-label="Call us"
              className="flex items-center justify-center w-9 h-9 rounded-lg bg-secondary/10 text-secondary hover:bg-secondary/20 transition-colors"
            >
              <svg
                width="18"
                height="18"
      ...
      {mobileOpen && (
        <div
          id="mobile-menu"
          className="lg:hidden border-t border-border bg-surface shadow-md"
        >
          <nav
          ...
          >
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border mt-1 px-1">
              <ThemeSwitcher variant="full" className="flex-1 mr-2" />
              <Link href="/contact" onClick={() => setMobileOpen(false)} className="flex-1">
                <Button className="w-full" variant="accent" size="sm">Get Free Quote</Button>
              </Link>
            </div>
          </nav>
        </div>
